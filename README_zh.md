...
本 Demo 基于涂鸦智能云平台、涂鸦智能APP、IoTOS Embeded WiFi &Ble SDK，使用涂鸦WiFi/WiFi+BLE系列模组快速组建一个伺服舵机demo，实现手机远程控制舵机的转动角度。
## 快速上手

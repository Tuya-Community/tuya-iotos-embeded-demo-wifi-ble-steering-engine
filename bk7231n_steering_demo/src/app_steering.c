...
OPERATE_RET app_steering_init(IN APP_MODE mode)
{
...
VOID app_report_all_dp_status(VOID)
{
    ...
    dp_arr[0].dpid = DPID_STEERING_ANGLE;
    dp_arr[0].type = PROP_VALUE;
    dp_arr[0].time_stamp = 0;
    dp_arr[0].value.dp_value = app_ctrl_data.pwm_value;
...
VOID deal_dp_proc(IN CONST TY_OBJ_DP_S *root)
{
    ...
    case DPID_STEERING_ANGLE:
        app_ctrl_data.pwm_value = root->value.dp_value;
        break;
    default:
        break;
    }
